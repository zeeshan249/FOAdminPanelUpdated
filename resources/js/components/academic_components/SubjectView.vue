          ...
          <v-container>
            ...
            >
              ...
              <div dense class="mx-2 text-center mb-2">
                <v-btn
                  v-permission="'Add Subject' | 'Edit Subject'"
                  class="ma-2 rounded"
                  tile
                  color="primary"
                  :disabled="
                    !issaveSubjectFormValid || issaveSubjectFormDataProcessing
                  "
                  @click="saveSubject"
...
export default {
  ...
  data() {
    return {
      ...
      excelData: [],
      excelFileName:
        "SubjectListAsExcel" + "_" + moment().format("DD/MM/YYYY") + ".xls",
    };
  },
  watch: {
  ...
  methods: {
        ...
        this.$http
          .post(
            "web_enable_disable_subject",
            {
              ...
              isSubjectActive: item.lms_subject_is_active == "Active" ? 0 : 1,
    ...
    saveSubject($event) {
      if (this.$refs.saveSubjectForm.validate()) {
        ...
        this.$http
          .post("web_save_update_subject", postData, this.authorizationConfig)
          .then(({ data }) => {
            ...
            if (
              ...
              // Course Code Exists
                ...
                this.changeSnackBarMessage(this.$t("label_subject_exists"));
              }
              // Course Saved
              else if (data.responseData == 2) {
                this.courseId = "";
                ...
                this.snackBarColor = "success";
                this.changeSnackBarMessage(this.$t("label_subject_saved"));
                this.getAllSubject(event);
              ...
              // Subject Updated
                ...
                this.snackBarColor = "success";
                this.changeSnackBarMessage(this.$t("label_subject_updated"));
                this.getAllSubject(event);
                this.isSaveEditClicked = 1;
                this.courseId = "";
                this.subjectName = "";
    ...
    savePDF() {
      ...
      pdfDoc.save(
        "SubjectListAsPDF" + "_" + moment().format("DD/MM/YYYY") + ".pdf"
      );
    },
  },
};
