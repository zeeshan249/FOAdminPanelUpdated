...
export default {
    props: ["userPermissionDataProps", "studentDataProps"],
    data() {
        return {
            // For Breadcrumb
            breadCrumbItem: [
            ...
            stepperInfo: 1,
            enquiryCode:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_enquiry_code
                    : "",

            selectedSourceId:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_information_source_id
                    : "",
            sourceItems: [],
            isSourceDataLoading: false,
            lms_child_course_id:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_child_course_id
                    : "",
            selectedCourseId:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_course_id
                    : "",
            courseItems: [],
            ...
            selectedSchoolId:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_enquiry_school_name
                    : "",
            schoolItems: [],
            ...
            firstName:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_enquiry_first_name
                    : "",
            lastName:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_enquiry_last_name
                    : "",
            fatherName:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_enquiry_father_name
                    : "",
            motherName:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_enquiry_mother_name
                    : "",
            ...
            selectedGender:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_enquiry_gender
                    : "",
            selectedMaritalStatus:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_enquiry_marital_status
                    : "",
            modalDOB: false,
            modalDOJ: false,
            selectedDOB:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_enquiry_date_of_birth
                    : new Date().toISOString().substr(0, 10),
            selectedDOJ:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_enquiry_date_of_joining
                    : new Date().toISOString().substr(0, 10),
            contactNumber:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_enquiry_mobile
                    : null,
            whatsAppNumber:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_enquiry_whatsapp_contact
                    : null,
            email:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_enquiry_email
                    : "",
            mobileRules: [],
            imageRule: [],
            ...
            currentAddress:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_enquiry_local_address
                    : "",
            permanentAddress:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_enquiry_permanent_address
                    : "",
            qualification:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_enquiry_qualification
                    : "",
            workExperience:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_enquiry_work_experience
                    : "",
            aboutEnquiry:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_enquiry_about
                    : "",
            enquiryId:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_enquiry_id
                    : "",
            enquiryUserId:
                this.studentDataProps != null
                    ? this.studentDataProps.lms_user_id
                    : "",
            isStudentBasicEdit: this.studentDataProps != null ? 1 : 0,
            whatsAppMobileRules: [],
