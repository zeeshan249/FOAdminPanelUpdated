...
export default {
    ...
    methods: {
        ...
        showStudentViewEdit(item) {
            this.studentViewEditDialog = true;
            this.firstName = item.lms_enquiry_first_name;
            this.lastName = item.lms_enquiry_last_name;
            this.fatherName = item.lms_enquiry_father_name;
            this.motherName = item.lms_enquiry_mother_name;
            this.selectedGender = item.lms_enquiry_gender;
            this.selectedMaritalStatus = item.lms_enquiry_marital_status;
            this.contactNumber = item.lms_enquiry_mobile;
            this.whatsAppNumber = item.lms_enquiry_whatsapp_contact;
            this.currentAddress = item.lms_enquiry_local_address;
            this.qualification = item.lms_enquiry_qualification;
            this.workExperience = item.lms_enquiry_work_experience;
            this.email = item.lms_enquiry_email;
            this.permanentAddress = item.lms_enquiry_permanent_address;
        },
        // Get all active sources
        getAllActiveSources() {
        ...
        getAllStudents(e) {
            ...
            this.$http
                .get(`web_get_all_students_internal?page=${e.page}`, {
                    params: postData,
                    headers: { Authorization: "Bearer " + ls.get("token") }
                })
                .then(({ data }) => {
